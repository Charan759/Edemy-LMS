...
const CourseDetails = () => {
  ...
  const { allCourses, caluclateRating, caluclateNoOfLectures,
    calculateCourseDuratoin, caluclateChapterTime, currency } = useContext(AppContext)
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
              ...
              <div className='flex items-center gap-1'>
                ...
                <p>{calculateCourseDuratoin(courseData)} </p>
              </div>
              <div className='h-4 w-px bg-gray-500/40'></div>
              <div className='flex items-center gap-1'>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                <li>Life time access with updates</li>
                <li>step-by-step, handson project guidance</li>
